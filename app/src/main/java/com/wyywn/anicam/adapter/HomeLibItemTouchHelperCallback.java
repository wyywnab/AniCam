...
public class HomeLibItemTouchHelperCallback extends ItemTouchHelper.Callback {

    private final HomeLibManagerAdapter mAdapter;

    public HomeLibItemTouchHelperCallback(HomeLibManagerAdapter adapter) {
        mAdapter = adapter;
    }
